# Generated by Django 4.1.4 on 2023-09-10 16:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('soloried', 'SOLORIED'), ('self employed', 'SELF EMPLOYED'), ('partnership', 'PARTNERSHIP'), ('proprietor', 'PROPRIETOR'), ('other', 'OTHER')], max_length=50)),
