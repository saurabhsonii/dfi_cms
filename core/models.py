...
class OccupationDetails(models.Model):
    ...
    itr = models.FileField(upload_to='occupationalDocuments',null=True,blank=True)
    id_card = models.FileField(upload_to='occupationalDocuments',null=True,blank=True)
    offer_later = models.FileField(upload_to='occupationalDocuments',null=True,blank=True)
